...
word_features_file = open("resources/wordFeatures", "r")
...
classifier_c5_file = open("resources/MNBayes_classifier_c5", "r")
classifier_c5 = pickle.load(classifier_c5_file)
classifier_c5_file.close()

classifier_pn_file = open("resources/SVC_classifier_pn", "r")
classifier_pn = pickle.load(classifier_pn_file)
classifier_pn_file.close()

print "The lyrics are classified as " + classifier_pn.classify(features) + " and lies in cluster " + classifier_c5.classify(features) + "."